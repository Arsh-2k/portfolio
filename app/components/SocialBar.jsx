  ...
  return (
    <div className="fixed bottom-4 left-4 sm:left-1/2 sm:-translate-x-1/2 z-50">
      ...
      <div
        className={`${
          isOpen ? 'flex' : 'hidden'
        } sm:flex flex-col sm:flex-row items-center gap-3 sm:gap-4 p-4 sm:px-6 sm:py-3 bg-black/30 backdrop-blur-md border border-white/10 shadow-lg rounded-3xl sm:rounded-full mt-4 sm:mt-0 transition-all duration-500 relative
