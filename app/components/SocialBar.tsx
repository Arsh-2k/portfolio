...
const icons = [
  ...
  {
    icon: <FaEnvelope />,
    link: "mailto:arshpreet2k6@gmail.com",
    label: "Email",
  },
  {
    icon: <FaLinkedin />,
...
const SocialBar = () => {
  ...
  return (
    <div className="fixed bottom-4 left-4 sm:left-1/2 sm:-translate-x-1/2 z-[9999]">
      ...
      <AnimatePresence>
        {isClient &&
          (isOpen || (windowWidth !== null && windowWidth >= 640)) && (
            <motion.div
              key="social-bar"
              ...
              className="flex flex-row items-center gap-3 sm:gap-5 p-3 sm:px-7 sm:py-4 backdrop-blur-lg bg-gradient-to-br from-[#190029]/80 via-[#1e003f]/80 to-[#2c004c]/80 border border-white/10 shadow-2xl rounded-xl sm:rounded-full animate-breath-glow relative"
            >
