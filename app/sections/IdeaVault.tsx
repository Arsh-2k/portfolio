...
const TagPill = ({ tag }: { tag: string }) => (
  <span
    className="bg-gradient-to-br from-pink-500 via-purple-500 to-indigo-500
               text-white text-xs px-3 py-1 rounded-full shadow-md select-none"
    aria-label={`Tag: ${tag}`}
  >
    #{tag}
  </span>
        ...
        <motion.article
          ...
          onKeyDown={(e) => {
            if (e.key === "Enter" || e.key === " ") {
              e.preventDefault();
              // Here you could add click handling or open details/modal
  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl w-full relative z-10">
        ...
        {/* 💡 Idea Grid */}
        <div className="grid gap-10 grid-cols-1 sm:grid-cols-2 lg:grid-cols-2" role="list">
          {ideaCards}
        </div>
      </div>
    </section>
